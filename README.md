...
For example, strings and numbers get translated into strings verbatim, the
...
The following code example generates an environment variable vector for a hash
